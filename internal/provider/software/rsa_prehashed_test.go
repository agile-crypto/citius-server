...
// ============================================================================
// RSA — Prehashed Signing via DigestSign/DigestVerify
//
...
// the caller declares via DigestSignRequest.hash_algorithm — the digest bytes
// alone never say which hash produced them.
// ============================================================================

func TestDigestSignVerify_RSAPSS_2048_SHA256_prehashed_roundTrip(t *testing.T) {
...
// TestDigestSignVerify_RSAPSS_hashAlgorithmSHA384_ignoresUnsetParamsHash
...
func TestDigestSignVerify_RSAPSS_hashAlgorithmSHA384_ignoresUnsetParamsHash(t *testing.T) {
	alg := rsaPSSDetails(2048, types.HashAlgorithm_HASH_ALGORITHM_UNSPECIFIED)
	p, keyMaterial := genRSAPSSKey(t, alg)
	ctx := context.Background()
...
func TestDigestVerify_RSAPSS_prehashed_tamperedSignature_returnsFalse(t *testing.T) {
	alg := rsaPSSDetails(2048, types.HashAlgorithm_HASH_ALGORITHM_UNSPECIFIED)
	p, keyMaterial := genRSAPSSKey(t, alg)
	ctx := context.Background()
...
func TestDigestSignVerify_RSAPKCS1v15_2048_SHA256_prehashed_roundTrip(t *testing.T) {
...
func TestDigestVerify_RSAPKCS1v15_prehashed_tamperedDigest_returnsFalse(t *testing.T) {
	alg := rsaPKCS1v15Details(2048, types.HashAlgorithm_HASH_ALGORITHM_UNSPECIFIED)
	p, keyMaterial := genRSAPKCS1v15Key(t, alg)
	ctx := context.Background()
...
// TestDigestSign_RSAPSS_keySizeMismatch_returnsError proves checkRSAKeySize
// still applies to the prehashed path — the same cross-check signRSAPSS uses.
func TestDigestSign_RSAPSS_keySizeMismatch_returnsError(t *testing.T) {
